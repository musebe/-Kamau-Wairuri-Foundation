...
const WhatWeDoPage = () => {
  const programsData = [
    ...
    },
    {
      ...
      description:
        "As physical and mental health challenges compound, there is a need to shift focus from mainly treating illness to promoting wellbeing in our communities. This enables people to live well, in the ways which matter to them, even when things are difficult. We are committed to supporting wellbeing in our communities.<br/>We do this through provision of group-based learning in the communities, such a through health talks, raising awareness on critical threats to public health (e.g. drugs and substance abuse, road safety) and providing appropriate short-term and long-term support to people in need in our communities. We particularly support the elderly, people with disabilities, and families going through crisis and grief.",
    ...
    },
    {
      ...
      description: `
        ...
        We are committed to promoting the empowerment of women and girls to enhance their self-worth, and so that they can make the right choices, access resources and opportunities and gain their voice to influence economic and social policy.<br/>We make effort to include groups of women, such as single mothers, who are further excluded from women’s economic empowerment activities.  
