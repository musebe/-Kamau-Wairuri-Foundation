const Page = () => {
  return (
    <div className='flex flex-col min-h-screen'>
      {' '}
      {/* Container takes at least the height of the screen */}
              ...
              <div className='md:flex-1'>
                <div className='bg-white p-6 rounded-lg shadow-xl'>
                  ...
                  <p className='mt-6 text-gray-600'>
                    Send your donation to M-Pesa Till Number{' '}
                    <strong>xxxxxx</strong> or to our account at Sidian Bank,
                    RiverRoad Branch, A/c No: <strong>_____</strong>.
                  </p>
                  <a
                    href='#'
